...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("allows_ai_processing", sa.Boolean(), nullable=False),
        sa.Column("allows_third_party_cloud", sa.Boolean(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("han_char_count", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("is_narrator", sa.Boolean(), nullable=False),
        created_at(),
        updated_at(),
    )
    op.create_table(
        ...
        sa.Column("pause_before_ms", sa.Integer(), nullable=False),
