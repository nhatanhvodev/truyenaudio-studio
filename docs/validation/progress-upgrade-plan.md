...
| U08 Provider/model và quality settings | PARTIAL | Part 1: `features/modelCatalog/ModelCatalog` (filter giá/context/benchmark, phân trang ≤100, nhãn "Chưa rõ giá"/"Chưa xác minh", banner stale, provenance link, benchmark badge chỉ khi có ref) + 6 test, gắn vào Settings→Models (b7d3d8e, 38405db); còn: profile CRUD credential masked, quality picker, quote/ceiling/consent từng stage |
