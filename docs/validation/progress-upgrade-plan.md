...
| U08 Provider/model và quality settings | PARTIAL | Part 1: `ModelCatalog` (filter giá/context/benchmark, phân trang ≤100, nhãn "Chưa rõ giá"/"Chưa xác minh", banner stale, provenance link, benchmark badge chỉ khi có ref) + 6 test, đã gắn vào Settings→Models; còn: profile CRUD credential masked, quality picker, quote/ceiling/consent từng stage |
