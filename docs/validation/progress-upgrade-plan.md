...
- M5: U01 code-complete (kiểm trực quan NOT_RUN); U04 DONE (code); U05 round 1–3 (reducer + API/hook + UI tab/dock trong shell; E2E/responsive NOT_RUN); U06 round 1 (editor song ngữ + QA inspector, IME/keyboard/critical guard); U07 round 1 (panel nháp job theo feed J04); U10 round 1 (storage retention/restore-copy + feature-flag guard + appearance prefs); U02/U08/U09 PARTIAL; U03 chưa thực hiện.
